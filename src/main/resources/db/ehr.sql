...
CREATE TABLE `personal`  (
  ...
  `phone` bigint(0) NULL DEFAULT NULL COMMENT '联系电话',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `identity` bigint(0) NULL DEFAULT NULL COMMENT '身份证号',
  ...
  `work_status` int(0) NULL DEFAULT NULL COMMENT '工作状态：1:正式 2:试用 3:实习 4:离职',
...
CREATE TABLE `personal_reward`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '奖罚ID',
  `personal_id` int(0) NULL DEFAULT NULL COMMENT '员工编号',
  ...
  `reward_kind` int(0) NULL DEFAULT NULL COMMENT '奖罚种类 1：奖励 2：惩罚',
  `reward_amount` int(0) NULL DEFAULT NULL COMMENT '金额',
...
CREATE TABLE `personal_salary`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '薪资管理ID',
  `personal_id` int(0) NULL DEFAULT NULL COMMENT '员工编号',
  `personal_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '员工姓名',
  `department_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门名称',
...
CREATE TABLE `personal_train`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '培训管理ID',
  `personal_id` int(0) NULL DEFAULT NULL COMMENT '员工id',
  `personal_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '员工姓名',
  `department_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门名称',
  `position_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '岗位名称',
...
CREATE TABLE `position`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '岗位编号',
  `position_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '岗位名称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '描述',
...
CREATE TABLE `recruitment`  (
  ...
  `recruit_status` int(0) NULL DEFAULT NULL COMMENT '状态  1:进行中 2：已完成',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
