...
public class SolutionServiceImpl extends ServiceImpl<SolutionMapper, Solution> implements SolutionService {
    ...
    @Override
    public Integer add(SolutionDto solutionDto, Integer databaseId) {
        //设置状态值
        ...
        judgeService.judge(SolutionConverter.toDto(solution), databaseId);
    ...
    private void addMessage(SolutionDto solutionDto) {
        ...
        if (user != null) {
            ...
            solutionDto.setIsAdmin(user.getIsAdmin());
        }
